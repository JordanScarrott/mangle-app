<template>
    <div id="app">
        <header>
            <h1>Gemini Nano Prompt API Tester</h1>
            <p>A simple interface to test the built-in Chrome AI Prompt API.</p>
        </header>
...
import { streamMangleSchemaFromStringStream } from "@/utils/jsonStreamParser";
